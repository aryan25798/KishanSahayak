...
import { collection, addDoc, query, orderBy, onSnapshot, serverTimestamp, getDocs, limit } from "firebase/firestore";
  ...
  const handlePost = async (e) => {
    ...
    try {
      ...
      if (image) {
        ...
        const imageRef = ref(storage, `forum_images/${Date.now()}-${compressedImage.name}`);

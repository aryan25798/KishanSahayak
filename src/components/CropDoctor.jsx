                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-slate-100 pb-6">
                    <div>
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <TTSButton text={`Diagnosis: ${result.name}. Severity: ${result.severity}. Organic Solution: ${result.organic}. Chemical Treatment: ${result.chemical}.`} className="w-8 h-8 rounded-full p-0 flex items-center justify-center shadow-sm" />
                      </div>
